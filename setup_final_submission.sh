...
if [ ! -d "src" ]; then
    echo "❌ Error: กรุณา cd เข้าไปใน product-management-layered ก่อนรันครับ"
    exit 1
fi

echo "📝 Generating Final Architecture Documentation (Strict ASCII Art)..."

# ========================================================
# 1. สร้างไฟล์ ARCHITECTURE.md (เน้น ASCII Art & Checklist)
# ========================================================
